        ...
        <Layout bgcolor="white">
            <Header>
                <HeaderColumnsWithSpace gridTemplateColumns="auto auto 1fr">
                    <a href="https://github.com/xcodemind/naturalcc" target="_blank" rel="noopener noreferrer">
                        <Logo width="147px"
                              height="26px"
                              alt="NaturalCC"
                        />
    ...
    render() {
        ...
        if (slug && !requestData) {
            ...
            const developLocallyDescription = (
                <span>
            <span>
              It's possible to run the NaturalCC demo locally using your own model (e.g., to visualize or interpret its predictions). See
            </span>
            <a href="https://github.com/allenai/NaturalCC-demo#contributing-a-new-model-to-the-demo" target="_blank"
            ...
            const modelDescription = (
                <span>
          <span>
            We are always looking to add user-contributed NaturalCC models as either components in the NaturalCC library or as part of this collection of demos.
            ...
            in adding your model to our list of publicly available implementations, as a service to this demo collection, or as a component in the NaturalCC library itself,
            please open an issue on our
          </span>
          <a href="https://github.com/xcodemind/naturalcc/issues" target="_blank" rel="noopener noreferrer">{' '} public GitHub repository </a>
          <span>
            or send us an email at XCodeMind.
          </span>
        </span>
